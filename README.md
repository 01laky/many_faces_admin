...
- **Operator dashboard** with platform-wide **statistics**, **charts** (`GET /api/Stats`, `GET /api/Stats/timeseries`), a **full metrics table**, an **“AI & public aggregates”** strip (current **off / inline / live** mode + optional preview of **`GET /api/Stats/public`**), **Settings** (general, **infrastructure smoke tests** for mail/push/search, AI statistics), and **AI Chat** that calls **`SendToAiWithOperatorStats`** — see [`docs/guides/admin-dashboard-metrics.md`](../docs/guides/admin-dashboard-metrics.md) and [`docs/guides/admin-settings-infrastructure-smoke-tests.md`](../docs/guides/admin-settings-infrastructure-smoke-tests.md).
